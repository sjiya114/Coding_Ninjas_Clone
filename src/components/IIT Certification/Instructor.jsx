...
function Instructor({category}) {
  return (
    <div  className='bg-gray-50 flex mt-20 flex-col space-y-2 items-center justify-center'>
        ...
        <div className='flex flex-row max-md:flex-col max-md:ml-10 max-md:mr-10 max-md:space-y-4 space-x-6 mt-10'>
            {coreData.map((data)=>(data.cat===category &&
               <div className='border-2 w-[40%] max-md:w-full border-gray-300 rounded-lg px-4 py-4  flex flex-col space-y-2'>
