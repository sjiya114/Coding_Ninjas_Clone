...
function Career() {
  return (
   <div  className='bg-gray-50 flex flex-col items-center justify-center'>
      ...
      <div className='flex flex-row space-x-4 space-y-4 mt-20 ml-[18%] flex-wrap'>
        {xservice.map((service)=>(
            <div className='flex border-2 px-4 py-4 border-gray-400 rounded-lg  w-[36%] h-[200px] flex-col space-y-2'>
