...
function Info({p1,p2,p3,p4,s1,s2,s3,s4}) {
  return (
    <div className='flex flex-row max-md:flex-col max-md:space-y-6  bg-gray-100'>
      <div className='flex w-[25%] max-md:w-full py-10 flex-col border-r-2 items-center justify-center border-gray-400 space-y-2'>
        <p>PROGRAM START</p>
        <img className='w-10 h-10' src="https://www.codingninjas.com/careercamp/wp-content/uploads/2024/10/clock.png" alt="" />
        <p>{p1}</p>
        <p>{s1}</p>
      </div>
      <div className='flex flex-col py-10 w-[25%] max-md:w-full  border-r-2 items-center justify-center border-gray-400  space-y-2'>
        <p>DURATION</p>
      ...
      <div className='flex flex-col py-10 w-[25%] max-md:w-full items-center justify-center space-y-2'>
        <p>ELIGIBILITY</p>
