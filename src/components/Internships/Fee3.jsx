  ...
  return (
    <div className=' bg-white py-20 '>
      ...
      <p className='font-bold text-3xl'>Join Now <span className='text-indigo-600'>Limited</span>  Seats Left</p>
          <div className='flex flex-row max-md:flex-col max-md:space-y-4 max-md:mx-4 border-t-1 border-b-1 py-10 space-x-5'>
...
₹79,999</button>
           <div className='flex flex-col space-y-6'>
            ...
            <div className='flex flex-row max-md:flex-col max-md:spaxe-y-4 justify-between'>
              <div>
                <p>Duration</p>
              ...
              <button className='text-white max-md:mt-5 bg-indigo-800 px-4 py-2 rounded-lg'>Enroll Now</button>
            </div>
           </div>
          </div>
          <div className='flex flex-row max-md:flex-col max-md:mx-4 space-x-6'>
...
₹2,500</button>
  ...
  <div className='flex flex-row max-md:flex-col space-x-4'>
