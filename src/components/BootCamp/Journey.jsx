...
function Journey() {
  return (
    <div className='bg-gray-100 px-8 overflow-hidden rounded-2xl mt-10 py-10 flex flex-row max-lg:flex-col justify-between max-w-screen-xl mx-auto'>
      <div className='flex flex-col space-y-4'>
        <p className='text-[#6249C5] font-bold'  >Bootcamp Journey</p>
        <p className='text-3xl font-semibold w-[80%] ' >Future-proof your career<span className='text-[#0065FF]'> with GenAI skills</span> </p>
      ...
      <div>
        ...
        <img className='rounded-full bg-white w-16 h-16 px-4 py-4  ml-6'  src="https://files.codingninjas.com/journey-rocket-1705661058.webp" alt="" />
         ...
         <div className='text-gray-500 text-sm'>
            <ol className='list-disc flex flex-col space-y-2'>
              <li>Orientation by Ankush Singla</li>
       ...
       <div className='flex flex-row'>
        ...
        <img className='rounded-full bg-white w-16 h-16 px-4 py-4  ml-6' src="https://files.codingninjas.com/journey-resilient-1705660976.webp" alt="" />
         ...
         <div className='text-gray-500'>
            <ol className='list-disc flex flex-col space-y-2'>
              <li>Daily jobs shared</li>
              <li>hirist.com highlights</li>
        ...
        <img className='rounded-full bg-white w-16 h-16 px-4 py-4  ml-6' src="https://files.codingninjas.com/journey-over-the-moon-1705660976.webp" alt="" />
         ...
         <div className='text-gray-500'>
            <ol className='list-disc flex flex-col space-y-2'>
              <li>Gain company insights</li>
              <li>Apply for higher offers</li>
            </ol>
         </div>
         </div>
         </div>
