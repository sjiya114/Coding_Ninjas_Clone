...
function Phone() {
    return (
        <div className='border-white mt-8 rounded-4xl mx-12  w-[60%] max-lg:w-[80%] max-md:w-full max-md:mx-0 h-fit border-1 shadow-md  shadow-spread-equal shadow-white'>
