...
function Create({dir}) {
  return (
    <div className='ml-[18%] flex flex-col mt-10 space-y-10'>
      ...
      <div className='bg-purple-200 flex flex-col space-y-2 mx-2 my-2 px-2 py-2 rounded-lg w-fit'>
        ...
        <div className='border-gray-500 w-[50%] rounded-lg bg-white'>
      <div className='flex flex-row space-x-6 rounded-lg bg-gray-200 mx-2 my-2'>
         <div className='w-[40%] flex flex-col rounded-lg px-2 items-center justify-center' >
